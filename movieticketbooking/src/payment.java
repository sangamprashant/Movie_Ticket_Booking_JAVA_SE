...
public class payment extends javax.swing.JFrame {
    ...
    private void initializeDatabase() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error loading the MySQL JDBC driver: " + e.getMessage());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error executing payment query: " + ex.getMessage());
        } finally {
            try {
